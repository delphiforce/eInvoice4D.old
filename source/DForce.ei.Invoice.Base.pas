...
type
  ...
  IXMLRappresentanteFiscaleCessionarioType = interface;
  ...
  IXMLFatturaElettronicaHeaderType = interface(IXMLNode)
    ...
    property TerzoIntermediarioOSoggettoEmittente: IXMLTerzoIntermediarioSoggettoEmittenteType
      read Get_TerzoIntermediarioOSoggettoEmittente;
  ...
  IXMLDatiTrasmissioneType = interface(IXMLNode)
    ...
    function Get_PECDestinatario: UnicodeString;
    ...
    procedure Set_PECDestinatario(Value: UnicodeString);
    { Methods & Properties }
    ...
    property PECDestinatario: UnicodeString read Get_PECDestinatario write Set_PECDestinatario;
    // AGGIUNTO V 1.2 - FINE
  end;
  ...
  IXMLCessionarioCommittenteType = interface(IXMLNode)
    ...
    function Get_Sede: IXMLIndirizzoType;
    function Get_StabileOrganizzazione: IXMLIndirizzoType;
    function Get_RappresentanteFiscale: IXMLRappresentanteFiscaleCessionarioType;
    { Methods & Properties }
    property DatiAnagrafici: IXMLDatiAnagraficiCessionarioType read Get_DatiAnagrafici;
    property Sede: IXMLIndirizzoType read Get_Sede;
    // AGGIUNTO V 1.2 - INIZIO
    property StabileOrganizzazione: IXMLIndirizzoType read Get_StabileOrganizzazione;
    property RappresentanteFiscale: IXMLRappresentanteFiscaleCessionarioType read Get_RappresentanteFiscale;
    // AGGIUNTO V 1.2 - FINE
  end;
  ...
  // AGGIUNTO V 1.2 - INIZIO
  IXMLRappresentanteFiscaleCessionarioType = interface(IXMLNode)
    ['{4CFC8F5C-BFE9-4943-ACF8-223A7B3D360B}']
    { Property Accessors }
    function Get_IdFiscaleIVA: IXMLIdFiscaleType;
    function Get_Denominazione: UnicodeString;
    function Get_Nome: UnicodeString;
  ...
  IXMLDettaglioPagamentoType = interface(IXMLNode)
    ...
    property DataRiferimentoTerminiPagamento: UnicodeString read Get_DataRiferimentoTerminiPagamento
      write Set_DataRiferimentoTerminiPagamento;
...
function LoadFatturaElettronica(const FileName: string): IXMLFatturaElettronicaType;
begin
  Result := LoadXMLDocument(FileName).GetDocBinding('FatturaElettronica', TXMLFatturaElettronicaType, TargetNamespace)
...
function TXMLDatiTrasmissioneType.Get_PECDestinatario: UnicodeString;
begin
  Result := ChildNodes['PECDestinatario'].Text;
end;
...
procedure TXMLDatiTrasmissioneType.Set_PECDestinatario(Value: UnicodeString);
begin
  ChildNodes['PECDestinatario'].NodeValue := Value;
end;
...
begin
  ...
  RegisterChildNode('Sede', TXMLIndirizzoType);
  RegisterChildNode('StabileOrganizzazione', TXMLIndirizzoType);
  RegisterChildNode('RappresentanteFiscale', TXMLRappresentanteFiscaleCessionarioType);
  inherited;
end;
...
function TXMLCessionarioCommittenteType.Get_RappresentanteFiscale: IXMLRappresentanteFiscaleCessionarioType;
begin
  Result := ChildNodes['RappresentanteFiscale'] as IXMLRappresentanteFiscaleCessionarioType;
end;
...
function TXMLCessionarioCommittenteType.Get_StabileOrganizzazione: IXMLIndirizzoType;
begin
  Result := ChildNodes['StabileOrganizzazione'] as IXMLIndirizzoType;
end;
...
begin
  ...
  FDatiOrdineAcquisto := CreateCollection(TXMLDatiDocumentiCorrelatiTypeList, IXMLDatiDocumentiCorrelatiType, 'DatiOrdineAcquisto')
    as IXMLDatiDocumentiCorrelatiTypeList;
  FDatiContratto := CreateCollection(TXMLDatiDocumentiCorrelatiTypeList, IXMLDatiDocumentiCorrelatiType, 'DatiContratto')
    as IXMLDatiDocumentiCorrelatiTypeList;
  FDatiConvenzione := CreateCollection(TXMLDatiDocumentiCorrelatiTypeList, IXMLDatiDocumentiCorrelatiType, 'DatiConvenzione')
    as IXMLDatiDocumentiCorrelatiTypeList;
  FDatiRicezione := CreateCollection(TXMLDatiDocumentiCorrelatiTypeList, IXMLDatiDocumentiCorrelatiType, 'DatiRicezione')
    as IXMLDatiDocumentiCorrelatiTypeList;
  FDatiFattureCollegate := CreateCollection(TXMLDatiDocumentiCorrelatiTypeList, IXMLDatiDocumentiCorrelatiType, 'DatiFattureCollegate')
    as IXMLDatiDocumentiCorrelatiTypeList;
...
begin
  FRiferimentoNumeroLinea := CreateCollection(TXMLRiferimentoNumeroLineaTypeList, IXMLNode, 'RiferimentoNumeroLinea')
    as IXMLRiferimentoNumeroLineaTypeList;
  inherited;
end;
...
begin
  ...
  FAltriDatiGestionali := CreateCollection(TXMLAltriDatiGestionaliTypeList, IXMLAltriDatiGestionaliType, 'AltriDatiGestionali')
    as IXMLAltriDatiGestionaliTypeList;
  inherited;
end;
...
begin
  ...
  FDettaglioPagamento := CreateCollection(TXMLDettaglioPagamentoTypeList, IXMLDettaglioPagamentoType, 'DettaglioPagamento')
    as IXMLDettaglioPagamentoTypeList;
  inherited;
end;
...
begin
  ...
  FRetrievalMethod := CreateCollection(TXMLRetrievalMethodType_dsList, IXMLRetrievalMethodType_ds, 'RetrievalMethod')
    as IXMLRetrievalMethodType_dsList;
...
begin
  ...
  FX509IssuerSerial := CreateCollection(TXMLX509IssuerSerialType_dsList, IXMLX509IssuerSerialType_ds, 'X509IssuerSerial')
    as IXMLX509IssuerSerialType_dsList;
...
procedure TXMLRappresentanteFiscaleCessionarioType.AfterConstruction;
begin
  inherited;
  RegisterChildNode('IdFiscaleIVA', TXMLIdFiscaleType);
end;

function TXMLRappresentanteFiscaleCessionarioType.Get_Cognome: UnicodeString;
begin
  Result := ChildNodes['Cognome'].Text;
end;

function TXMLRappresentanteFiscaleCessionarioType.Get_Denominazione: UnicodeString;
begin
  Result := ChildNodes['Denominazione'].Text;
end;

function TXMLRappresentanteFiscaleCessionarioType.Get_IdFiscaleIVA: IXMLIdFiscaleType;
begin
  Result := ChildNodes['IdFiscaleIVA'] as IXMLIdFiscaleType;
end;

function TXMLRappresentanteFiscaleCessionarioType.Get_Nome: UnicodeString;
begin
  Result := ChildNodes['Nome'].Text;
end;

procedure TXMLRappresentanteFiscaleCessionarioType.Set_Cognome(Value: UnicodeString);
begin
  ChildNodes['Cognome'].NodeValue := Value;
end;

procedure TXMLRappresentanteFiscaleCessionarioType.Set_Denominazione(Value: UnicodeString);
begin
  ChildNodes['Denominazione'].NodeValue := Value;
end;

procedure TXMLRappresentanteFiscaleCessionarioType.Set_Nome(Value: UnicodeString);
begin
  ChildNodes['Nome'].NodeValue := Value;
end;
